...
export default function Contact() {
  ...
  const socialLinks = [
    { icon: 'ri-linkedin-fill', href: 'https://www.linkedin.com/in/darren-flores-897067293', label: 'LinkedIn' },
    { icon: 'ri-github-fill', href: 'https://github.com/JobStar-success', label: 'GitHub' },
